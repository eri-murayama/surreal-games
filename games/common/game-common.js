...
(function () {
  ...
  const BGM_PRESETS = {
    ...
    // バトル・対戦系（リバーシマスター）— 格闘ゲーム風パンチBGM
    // 休符・連打・オクターブ跳躍・半音で他プリセットと完全差別化
    battle: {
      tempo: 160, key: 'Em', wave: 'square', volume: 0.22,
      melody: [
        // フレーズ1: 連打→大跳躍（パワー系）
        330, 330, 0, 659, 0, 587, 494, 0,
        // フレーズ2: 半音上昇→高音炸裂
        392, 440, 466, 494, 0, 659, 0, 587,
        // フレーズ3: 急降下カウンター
        659, 587, 494, 0, 392, 370, 330, 0,
        // フレーズ4: オクターブ跳躍でクライマックス
        330, 659, 494, 988, 0, 784, 659, 330,
      ],
      bass: [
        165, 165, 0, 165, 330, 0, 247, 0,
        196, 220, 0, 247, 0, 330, 0, 294,
        330, 294, 247, 0, 196, 185, 165, 0,
        165, 330, 247, 494, 0, 392, 330, 165,
      ],
      // 金管ブラス層（重い一撃アクセント）
      brass: [
        165, 0, 0, 330, 0, 0, 247, 0,
        0, 0, 0, 247, 0, 330, 0, 0,
        330, 0, 247, 0, 0, 0, 165, 0,
        165, 330, 0, 494, 0, 0, 330, 165,
      ],
      // パンチ感のあるシンコペーション（短-短-長で叩きつけ）
      swing: [
        0.6, 0.6, 1.5, 0.6, 1.5, 0.8, 0.6, 1.5,
        0.7, 0.7, 1.4, 0.6, 1.5, 0.6, 1.5, 0.8,
        0.6, 0.7, 0.6, 1.5, 0.7, 0.7, 0.6, 1.5,
        0.6, 0.6, 0.7, 0.6, 1.5, 0.8, 0.6, 1.5,
      ]
    },
  };
