...
(function () {
  ...
  const BGM_PRESETS = {
    ...
    // バトル・対戦系（リバーシマスター）— Bm爽快バトル、brass層で重厚感
    battle: {
      tempo: 170, key: 'Bm', wave: 'sawtooth', volume: 0.22,
      melody: [
        494, 587, 659, 740, 880, 740, 659, 587,
        494, 659, 740, 880, 988, 880, 740, 659,
        392, 494, 587, 659, 740, 659, 587, 494,
        587, 659, 740, 880, 988, 880, 740, 587,
      ],
      bass: [
        247, 247, 294, 294, 370, 370, 294, 294,
        247, 247, 330, 330, 370, 370, 247, 247,
        196, 196, 247, 247, 294, 294, 330, 330,
        294, 294, 370, 370, 440, 440, 294, 294,
      ],
      // 金管ブラス層（パワフルなアクセント）
      brass: [
        247, 0, 294, 0, 370, 370, 0, 0,
        247, 0, 0, 0, 370, 370, 0, 247,
        196, 0, 247, 0, 294, 294, 0, 0,
        294, 0, 370, 0, 440, 0, 294, 294,
      ],
      swing: [
        1.1, 0.9, 1.0, 0.9, 1.2, 0.8, 1.0, 1.1,
        1.1, 0.9, 1.0, 0.8, 1.2, 0.9, 1.0, 1.1,
        1.0, 0.9, 1.1, 0.9, 1.2, 0.8, 1.0, 1.1,
        1.1, 0.9, 1.0, 0.8, 1.2, 0.9, 1.1, 0.9,
      ]
    },
  };
