...
(function () {
  ...
  const I18N = {
    ...
    en: {
      ...
      labelGhost: 'GHOST',
      labelYourInputs: 'YOUR INPUTS',
      msg_machine: 'The man became a machine.',
      msg_close: 'The man stopped, so close.',
      msg_home: 'The man was sent home.',
    },
  };
  ...
  const minigames = [
    ...
    },
    {
      ...
      draw: (s, elapsed) => {
        ...
        ctx.fillText(s.side === 'L' ? (curLang === 'en' ? 'TAP RIGHT' : '右をタップ') : (curLang === 'en' ? 'TAP LEFT' : '左をタップ'), 250, 80);
        void prog;
      },
      onClick: (s, x) => {
        const safe = s.side === 'L' ? (x > 250) : (x < 250);
    ...
    // ---------- ACT 2 ----------
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'hello?' : 'こんにちは?', s.x, s.y - 100);
      },
      onClick: (s, x, y) => {
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'HOLD TO POUR' : '長押しで注ぐ', 250, 160);
        ctx.fillText(curLang === 'en' ? 'STOP AT LINE' : '線で止める', 250, 200);
      },
      onClick: () => null,
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 20px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'TAP WHEN FULL' : 'いっぱいでタップ', 250, 120);
        ctx.fillText(curLang === 'en' ? 'BREATHE' : '深呼吸', 250, 256);
      },
      onClick: (s) => {
        const sinVal = Math.sin(s.phase);
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'WATER IT' : '水をやる', 250, 60);
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'PICK THE' : 'この色の', 250, 70);
        ctx.fillStyle = s.targetColor;
        ctx.fillRect(215, 90, 70, 30);
        ctx.fillStyle = '#000';
        ctx.fillText(curLang === 'en' ? 'ONE' : '花を摘む', 250, 150);
        // 花
        s.flowers.forEach(f => {
          ctx.strokeStyle = '#2e7d32';
          ctx.lineWidth = 3;
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'CATCH 3 LEAVES' : '葉を3枚キャッチ', 250, 470);
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 28px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'WAVE BACK' : '手を振り返す', 250, 100);
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'COUNT THEM' : '数えて', 250, 80);
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'ANSWER' : '電話に', 250, 120);
        ctx.fillText(curLang === 'en' ? 'THE PHONE' : 'でる', 250, 150);
      },
      onClick: (s, x, y) => {
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        ctx.font = 'bold 22px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'EAT EVERYTHING' : 'ぜんぶ食べる', 250, 80);
    ...
    },
    {
      ...
      draw: () => {
        ...
        ctx.font = 'bold 24px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'SMILE' : '笑顔', 250, 385);
        ctx.fillStyle = '#000';
        ctx.font = '14px monospace';
        ctx.fillText(curLang === 'en' ? 'press to smile anyway' : '笑えなくても押す', 250, 100);
      },
      onClick: (s, x, y) => {
    ...
    },
    {
      ...
      draw: () => {
        ...
        ctx.font = 'bold 32px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'AGREE?' : '同意する？', 250, 160);
        // YES
        ctx.fillStyle = '#39ff14';
        ctx.fillRect(70, 280, 160, 90);
        ctx.fillStyle = '#000';
        ctx.font = 'bold 36px monospace';
        ctx.fillText(curLang === 'en' ? 'YES' : 'はい', 150, 335);
        // NO
        ctx.fillStyle = '#888';
        ctx.fillRect(270, 280, 160, 90);
        ctx.fillStyle = '#000';
        ctx.fillText(curLang === 'en' ? 'no' : 'いいえ', 350, 335);
      },
      onClick: (s, x, y) => {
        if (y > 280 && y < 370) {
    ...
    // ↓狂気のミニゲーム
    {
      ...
      draw: () => {
        ...
        ctx.font = 'bold 36px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'OBEY' : '従え', 250, 200);
        // OKボタン
        ctx.fillStyle = '#39ff14';
        ctx.fillRect(170, 270, 160, 80);
        ctx.fillStyle = '#000';
        ctx.font = 'bold 32px monospace';
        ctx.fillText(curLang === 'en' ? 'OK' : 'はい', 250, 322);
      },
      onClick: (s, x, y) => {
    ...
    },
    {
      ...
      draw: (s) => {
        ...
        // 指示(画像の上に重ねる、白縁取りで読みやすく)
        ctx.textAlign = 'center';
        ctx.font = 'bold 24px sans-serif';
        ctx.lineWidth = 5;
        ctx.strokeStyle = '#fff';
        ctx.strokeText(s.prompt, 250, 50);
        ctx.fillStyle = '#000';
        ctx.fillText(s.prompt, 250, 50);
        ctx.font = 'bold 14px sans-serif';
        ctx.lineWidth = 3;
        ctx.strokeStyle = '#fff';
        ctx.strokeText(`${s.count}/${s.need}`, 250, 75);
        ctx.fillStyle = '#666';
    ...
    },
    {
      ...
      draw: (s, elapsed) => {
        ...
        ctx.font = 'bold 32px monospace';
        ctx.textAlign = 'center';
        ctx.fillText(curLang === 'en' ? 'WAIT' : '待て', 250, 200);
        ctx.font = '18px monospace';
        ctx.fillText(curLang === 'en' ? 'do not move' : '動くな', 250, 250);
        ctx.fillText(curLang === 'en' ? 'do not click' : 'クリックするな', 250, 280);
        // タイマー
        ctx.strokeStyle = '#000';
  ...
  function loop() {
    ...
    if (currentCombo >= 3) {
      ...
      ctx.font = 'bold 22px monospace';
      ctx.textAlign = 'right';
      ctx.fillText(curLang === 'en' ? `x${currentCombo} COMBO!` : `x${currentCombo} 連続！`, 490, 30);
    }
    drawPauseText();
    applyShakeTransform();
  ...
  function startGhostReplay() {
    ...
    function tick() {
      ...
      gctx.fillText(curLang === 'en' ? 'YOUR INPUTS' : 'あなたの操作', 6, 12);
  ...
  const ENDINGS = {
    ...
    machine: {
      ...
      en: [
        ...
        'no one looked back.',
        '',
        'At last, the man became a machine.',
        'His dream came true.',
        'Sort of.',
      ],
    },
  ...
  function showDreamRain(onDone) {
    ...
    let t = 0;
    const dreamWord = curLang === 'en' ? 'DREAM' : '夢';
    function frame() {
      t++;
  ...
  function showBoyScene() {
    ...
    function frame() {
      ...
      if (protagonistImg.complete && protagonistImg.naturalWidth > 0) {
        ...
        bctx.fillText(curLang === 'en' ? 'loading...' : '読み込み中...', 50, 450);
      }
      // キラキラ(憧れの目)
      if (state.t % 30 === 0) {
